...
if(!INITIALIZED_CUSTOM_ENV_TAG){
      ...
      # pip install uv 
      # uv pip install --upgrade uv streamlit fake_headers langchain_groq langchain_community langgraph python-dotenv langchain_openai arxiv wikipedia ddgs socksio pysocks requests langchain-tavily beautifulsoup4 selenium 
